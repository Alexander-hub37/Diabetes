...
def user_report():
  ...
  glucose = st.sidebar.slider('Glucosa', 0,200, 120 )
  bp = st.sidebar.slider('Presión arterial', 0,122, 70 )
  skinthickness = st.sidebar.slider('Skin Thickness', 0,100, 20 )
  insulin = st.sidebar.slider('Insulina', 0,846, 79 )
  bmi = st.sidebar.slider('BMI', 0,67, 20 )
  dpf = st.sidebar.slider('Diabetes Pedigree Function', 0.0,2.4, 0.47 )
  age = st.sidebar.slider('Edad', 21,88, 33 )
